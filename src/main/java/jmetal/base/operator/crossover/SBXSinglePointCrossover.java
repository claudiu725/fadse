...
public class SBXSinglePointCrossover extends Mutation {
	...
	public Object execute(Object object) throws JMException {
		...
		if (((parents[0].getType().getClass() != ARRAY_REAL_AND_BINARY_SOLUTION) &&
				(parents[1].getType().getClass() != ARRAY_REAL_AND_BINARY_SOLUTION))) {
		...
		Solution [] offSpring;
		offSpring = doCrossover(realProbability, 
				binaryProbability, 
				parents[0],
				parents[1]);
